...
#define STRING_CONFIG_H_AUTHOR "(Martin Filip, TEVO Tarantula config)" // Who made the changes.
...
#define DEFAULT_ACCELERATION          700    // Custom for TEVO Tarantula
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define RIGHT_PROBE_BED_POSITION 154
  #define FRONT_PROBE_BED_POSITION 46
  #define BACK_PROBE_BED_POSITION 154
